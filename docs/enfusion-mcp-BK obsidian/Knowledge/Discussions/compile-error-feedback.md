...
- Quotes the create-mod prompt workflow (`src/prompts/create-mod.ts:143`): "If compilation failed (errors in the Workbench console), fix with project_write." - but notes Claude has no way to see those errors.
